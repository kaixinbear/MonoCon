# dataset settings
dataset_type = 'VKittiMonoDatasetMonoCon'
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'vkitti_infos_train_mono3d.coco.json',
        info_file=data_root + 'vkitti_infos_train.pkl',
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'vkitti_infos_val_mono3d.coco.json',
        info_file=data_root + 'vkitti_infos_val.pkl',
        img_prefix=data_root,
        classes=class_names,
